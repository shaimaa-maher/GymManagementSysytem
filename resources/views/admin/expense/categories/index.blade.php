            ...
            <table class="table table-bordered w-75 text-center">
                ...
                @foreach($categories as $category)
                        <tr>
                            ...
                            <td>{{$category->name}}</td>
                            <td>
                                <button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#editCat{{$category->id}}">
                        ...
                        <!--EDIT MODAL-->
                        <div class="modal fade" id="editCat{{$category->id}}">
                        ...
                        <!--DELETE MODAL-->
                        <div class="modal fade" id="deleteCat{{$category->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                ...
                <tbody>
                    @foreach($Subcat as $category)
                        <tr>
                            ...
                            <td>{{$category->name}}</td>
                            <td>
                                <button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#editSubCat{{$category->id}}">
                                    <i class="fa fa-edit"></i> Edit
                                </button>
                        ...
                        <!--EDIT MODAL-->
                        <div class="modal fade" id="editSubCat{{$category->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
