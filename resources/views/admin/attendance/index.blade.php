                      ...
                      @foreach($members as $member)
                        <tr>
                          ...
                          @else
                            ...
                            <td><b style="color: rgb(207, 204, 12);">{{$member->type}}</b></td>
                            <td>{{$member->trainer->card_id}}</td>
                            <td>{{null}}</td>
                            <td>{{$member->created_at->toDateString()}}</td>
                            <td>{{$member->created_at->format('g:i A')}}</td>
                            <td><a class="btn btn-primary btn-sm" href="{{route('trainer.profile',$member->trainer_id)}}"><i class="fa fa-eye"></i> Show</a></td>
                          @endif
                        </tr>
                      @endforeach
